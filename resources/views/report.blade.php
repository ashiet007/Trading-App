                        ...
                        <table class="mainn"
                           ...
                           <tr>
                              <td style="width:33.333%;text-align:left;padding:20px 20px;background-color:#fff!important;" class="ssaii">
                                 ...
                                 <p style="font-size:16px;color:#000;line-height: 1.5;text-align: left;margin-bottom:0;">Thank You for choosing us. Below you can find your trading report:</p>
                              </td>
                           </tr>
                           <tr>
                                    ...
                                    <tr>
                                       <td style="padding:0;">
                                          <table style=" border-radius: 8px;width:100%;margin:auto;border-collapse: collapse;padding: 20px;">
                                             <tr>
                                                <th style="background-color:#ddd;padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;"><strong>Date</strong></th>
                                                <th style="background-color:#ddd;padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;"><strong>Buy</strong></th>
                                                <th style="background-color:#ddd;padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;"><strong>Sell</strong></th>
                                                <th style="background-color:#ddd;padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;"><strong>Profit/Loss</strong></th>
                                                <th style="background-color:#ddd;padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;"><strong>Brokerage</strong></th>
                                             </tr>
                                             <tr>
                                                <td style="background-color:#ddd;padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;"><strong>{{\Carbon\Carbon::parse($startDate)->format('d/m/Y')}} - {{\Carbon\Carbon::parse($endDate)->format('d/m/Y')}}</strong></td>
                                                <td style="padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;">£{{$buyTotal}} </td>
                                                <td style="padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;">£{{$sellTotal}}  </td>
                                                @php
                                                    $borkergae = $totalPnL * 0.025;
                                                @endphp
                                                <td style="padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;">£{{$totalPnL - $borkergae}} </td>
                                                <td style="padding:8px;border:1px solid #666;font-size:14px;color:#000;line-height: 1.5;">£{{$borkergae}} </td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
