...
const BuySell = (props) => {
    ...
    const sellPrice = allBookTickers[props.currency]
        ? Number(allBookTickers[props.currency].b).toFixed(tickSize)
        : 0.0;
    const buyPrice = allBookTickers[props.currency]
        ? Number(allBookTickers[props.currency].a).toFixed(tickSize)
        : 0.0;
